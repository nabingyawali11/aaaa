...
async function ensureTables(client) {
  ...
  `);
  await client.query(`
    CREATE TABLE IF NOT EXISTS gallery_submitted_attempts (
      id SERIAL PRIMARY KEY,
      value TEXT NOT NULL,
...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      if (type === "submission") {
        await client.query(
          "INSERT INTO gallery_submitted_attempts (value, is_correct, ip, user_agent) VALUES ($1, $2, $3, $4)",
          [value, isCorrect, ip, userAgent],
        );
      } else {
        await client.query(
          "INSERT INTO gallery_access_logs (value, ip, user_agent) VALUES ($1, $2, $3)",
          [value, ip, userAgent],
        );
      }
    } finally {
