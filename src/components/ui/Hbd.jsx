        ...
        <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
                    ...
                    >
                        <div
                            ...
                            style={{
                                width: b.size,
                                height: b.size * 1.2,
                                background: `radial-gradient(circle at 32% 28%, rgba(255,255,255,0.35), transparent 45%), linear-gradient(135deg, ${BALLOON_COLORS[i % BALLOON_COLORS.length]
                                    }, ${BALLOON_COLORS[i % BALLOON_COLORS.length]}99)`,
                                boxShadow: `0 0 40px -8px ${BALLOON_COLORS[i % BALLOON_COLORS.length]
                                    }66`,
                            }}
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    borderTop: `8px solid ${BALLOON_COLORS[i % BALLOON_COLORS.length]
                                        }`,
                                }}
                            />
                        </div>
            ...
            <div className="relative z-10 mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-16 sm:px-8">
                ...
                >
                    ...
                    >
                        Today the world celebrates the day it became a little brighter.
                        May this year bring you all the laughter, love, and light you've
                        given everyone around you. Here's to you — and to every beautiful
                        moment still waiting ahead.
                    </motion.p>
